...
def get_post(post_id):
    try:
        post = db.session.execute('SELECT user.comment_avatar, postboard.id, postboard.show_name, post.user_id, post.user_name, post.title, post.content, post.create_time, post.like_count, post.comment_count\
